...
export const LOCAL_STORAGE_AUTH_KEY = 'SCRMauth';
export const LOCAL_STORAGE_CLICK_ID = 'SCRMclickID';
export const LOCAL_STORAGE_CLICK_ID_VALID = 'SCRMclickIDValid';
export const LOCAL_STORAGE_WMID = 'SCRMwmid';
export const LOCAL_STORAGE_WMID_VALID = 'SCRMwmidValid';
export const LOCAL_STORAGE_AFF_ID = 'SCRMaffID';
export const LOCAL_STORAGE_AFF_ID_VALID = 'SCRMaffIDValid';
export const LOCAL_STORAGE_REFERER = 'SCRMreferer';
export const LOCAL_STORAGE_REFERER_VALID = 'SCRMrefererValid';
export const LOCAL_STORAGE_YA_CLIENT_ID = 'SCRMyaClientID';
export const LOCAL_STORAGE_YA_CLIENT_ID_VALID = 'SCRMyaClientIDValid';
export const LOCAL_STORAGE_EMAIL_CONFIRMATION = 'SCRMemailConfirmation';
export const LOCAL_STORAGE_ACCESS_RECOVERY_CONFIRMATION =
  'SCRMaccessRecoveryConfirmation';
